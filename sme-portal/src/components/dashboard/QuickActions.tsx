...
export default function QuickActions() {
  return (
    <div className="min-h-[380px] rounded-lg border border-[#e9eef8] bg-white px-6 py-5 shadow-sm">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        {actions.map((action) => (
          <Link
            key={action.label}
            to={action.path}
            className="flex h-[78px] items-center gap-4 rounded-md border border-[#d8e2f3] bg-[#f8faff] px-5 py-4 text-left transition hover:border-[#a9bcf5] hover:bg-white hover:shadow-[0_8px_20px_rgba(49,92,255,0.08)]"
          >
